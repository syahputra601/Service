    ...
    <script src="<?php echo base_url();?>asset/jquery/jquery.browser.js"></script>
    <script src="<?php echo base_url();?>asset/jquery/jquery.sparkline.min.js"></script>
    <script src="<?php echo base_url();?>asset/js/jquery-ui.js"></script>
    <script src="<?php echo base_url();?>asset/js/jquery.cookie.js" type="text/javascript"></script>
    <link href="<?php echo base_url();?>asset/js/jquery-confirm.min.css" type="text/css" rel="stylesheet" media="all">
