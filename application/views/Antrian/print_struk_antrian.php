    ...
    <div style="border: 1px solid; padding: 5px;">
        ...
        <div style="border: 1px solid;">
            <table border="0" style="text-align: center;">
                <tr>
                    <td style="padding-left: 95px; padding-top: 10px;">Kode Antrian :</td>
                </tr>
                <tr>
                    <td style="padding-left: 95px; padding-top: 10px;"><?= @$Vkode_antrian ?></td>
                </tr>
                <tr>
        ...
        <div style="border: 1px solid;">
            <table border="0" style="text-align: center;">
                <tr>
                    <td style="padding-left: 7px;">Silahkan Menunggu Kode Antrian Anda.</td>
                </tr>
                <tr>
                    <td style="padding-left: 7px;">Terimakasih.</td>
                </tr>
            </table>
        </div>
    </div>
