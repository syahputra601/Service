        ...
        <div class="container-fluid">
            <div class="block-header">
              <ol class="breadcrumb breadcrumb-bg-red">
                  ...
                  <a href="javascript:void(0);">Form Pelanggan</a>
                  </li>
              </ol>
            </div>
            <!-- Example Tab -->
                            ...
                            <form id="" action="<?php echo @$url_save; ?>" method="POST">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" placeholder="Kode Pelanggan" name="kode_pel" id="kode_pel" value="<?= @$kodePel ?>" readonly required>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 50px; text-align: center;">:</td>
                                        <td>
                                            <input type="text" class="form-control" placeholder="Nama Pelanggan" name="nama" id="nama" required="" onkeypress="return /[a-z ]/i.test(event.key)">
                                        </td>
                                    </tr>
                                    <tr style="height: 10px;"></tr>
                                    <tr>
                                        ...
                                        <td style="width: 50px; text-align: center;">:</td>
                                        <td>
                                            <input type="email" class="form-control" placeholder="xyz@ymail.com" name="email" id="email" required="">
                                        </td>
                                    </tr>
                                    <tr style="height: 10px;"></tr>
                                    <tr>
                                        ...
                                        <td style="width: 50px; text-align: center;">:</td>
                                        <td>
                                            <input type="text" class="form-control" placeholder="Jakarta" name="tempat_lahir" id="tempat_lahir" required="" onkeypress="return /[a-z ]/i.test(event.key)">
                                        </td>
                                    </tr>
                                    <tr style="height: 10px;"></tr>
                                    <tr>
