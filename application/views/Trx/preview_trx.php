...
<center>
<?php
    $print_nota = base_url('TRX/cetak_report_nota_pembayaran?id_transaksi='.@$id_transaksi.'&no_invoice='.@$no_invoice);
?>
    <a href="<?= @$print_nota ?>" target="_blank">Cetak Data</a><br><br>
</center>
<?php
...
<div style="padding-left: 5%; padding-right: 5%;">
    ...
    <div style="text-align: right; padding-right: 5%;">
        ...
        ?>
        <p style="padding-right: 30px;">Kasir</p>
    </div>
</div>
</body>
</html>