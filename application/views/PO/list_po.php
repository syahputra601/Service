                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tr>
                                      ...
                                      <td style="width: 20%;">
                                        <!-- START CODING VIEW -->
                                        <?php
                                        $view_antrian = base_url('PO/viewPO?id_po='.$row->id_po.'&nomor_po='.$row->nomor_po);
                                        ?>
                                        <a href="<?= @$view_antrian ?>"><button class="btn bg-purple btn waves-effect">View</button></a>
                                        <!-- END CODING VIEW -->
                                        <!-- START CODING EDIT -->
                                        <!-- <a href="<?php echo base_url('PO/editPO/'.$row->id_po);?>"><button class="btn bg-blue btn waves-effect">Edit</button></a> -->
                                        <!-- END CODING EDIT -->
                                        <!-- START CODING DELETE NEW -->
                                        <?php
                                        $url_delete = base_url('PO/deletePO?id_po='.$row->id_po);
                                        ?>
