    ...
    <div style="border: 1px solid; padding: 5px;">
        ...
        <div style="padding-left: 2%; padding-right: 5%;">
            <div style="width: 100%;">
               <table border="0" style="width: 100%;">
                    <tr>
                        <td style="width: 52%;">Telah Diterima Motor dengan Nomor Polisi</td>
            ...
            <div style="width: 100%;">
               <table border="0" style="width: 100%;">
                    <tr>
                        ...
                        <td style="text-align: center; width: 5%;">Pemilik Motor</td>
                        <td style="text-align: center; width: 5%;">Yang Menerima</td>
                    </tr>
